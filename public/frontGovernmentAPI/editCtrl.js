        ...
        $http
            ...
            .then(function(response) {
                ...
                switch (response.status) {
                    case 401:
                        M.toast('<i class="material-icons">error_outline</i> Apikey Missing', 4000);
                        break;
                    case 403:
                        M.toast('<i class="material-icons">error_outline</i> Incorrect Apikey', 4000);
                        break;
                    case 404:
                        M.toast('<i class="material-icons">error_outline</i> Data not found', 4000);
                        break;
                    default:
    ...
    $scope.editData = function(data) {
        ...
        $http
            ...
            .then(function(response) {
                ...
                M.toast('<i class="material-icons">done</i> ' + data.country + '  correctly edited', 4000);
                $location.path('/governments');
            }, function(response) {
                switch (response.status) {
                    case 400:
                        M.toast('<i class="material-icons">error_outline</i> Wrong Data entered', 4000);
                        break;
                    case 401:
                        M.toast('<i class="material-icons">error_outline</i> Apikey Missing', 4000);
                        break;
                    case 403:
                        ...
                        break;
                    default:
                        M.toast('<i class="material-icons">error_outline</i> Error editing data', 4000);
                        break;
                }
            });
    };
